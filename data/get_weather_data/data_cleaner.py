...
class DataCleaner:
    ...
    def csvs_to_df(self):
        ...
        source_directory = "."
        target_directory = os.path.join(source_directory, "data\\raw_csv")
        ...
        target_path = os.path.join(".","data\\pickles", pkl_name)
...
clean_data.send_clean_files_to_folder("csv","data\\clean_csv")
